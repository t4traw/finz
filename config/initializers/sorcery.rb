BASE_DOMAIN = Rails.env.production? ? "https://www.finz.me" : "http://localhost:3000"
...
Rails.application.config.sorcery.submodules = [:external, :remember_me, :user_activation, :reset_password]
...
Rails.application.config.sorcery.configure do |config|
  ...
  config.twitter.callback_url = "#{BASE_DOMAIN}/oauth/callback/twitter"
  config.twitter.user_info_path = "/1.1/account/verify_credentials.json?include_email=true"
  config.twitter.user_info_mapping = {
    name: "screen_name",
    email: "email",
    profile: 'description',
    sns_image: "profile_image_url_https",
  }
  #
  # config.facebook.key = ""
  # config.facebook.secreta = ""
  ...
  # config.discord.callback_url = "https://www.finz.me/oauth/callback?provider=discord"
